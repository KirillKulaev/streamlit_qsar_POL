...
st.markdown('To use the model go to the OCHEM website. Enter the Calculate Descriptors tab. Choose 2d and 3d MORDRED descriptors and then upload the resulting file below. Make sure you load berberine derivatives because this model can predict POL inhibition only for this class of chemical compounds.')
